...
static void gps_emit_due_samples(const telemetry_gps_fix_t *fix)
{
...
static void parse_gga_sentence(const char *line, telemetry_gps_fix_t *fix)
{
    char utc[16];
    char lat[20];
    char ns[3];
...
static void parse_rmc_sentence(const char *line, telemetry_gps_fix_t *fix)
{
    char utc[16];
    char status[3];
    char lat[20];
...
static bool parse_nmea_sentence(const char *line, telemetry_gps_fix_t *fix)
{
