...
static TaskHandle_t logger_task_handle = nullptr;
static TaskHandle_t sd_task_handle     = nullptr;
...
static QueueHandle_t twai_rx_queue = nullptr;
static twai_node_handle_t node_hdl = nullptr;
...
void app_main(void)
{
    ...
    ESP_ERROR_CHECK(twai_node_register_event_callbacks(node_hdl, &cbs, nullptr));
    ...
    xTaskCreate(logger_task,    "logger",    4096, nullptr,        9,  &logger_task_handle);
