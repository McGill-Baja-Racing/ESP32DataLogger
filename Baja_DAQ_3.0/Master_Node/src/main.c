...
#ifndef MASTER_GPS_ENABLED
#define MASTER_GPS_ENABLED 0
#endif

#ifndef MASTER_RPM_ENABLED
#define MASTER_RPM_ENABLED 0
#endif
 ...
 * configuration, serial commands, and local JSON helpers.
 *
 ...
 * - JSON status helpers: master_format_*_json().
 *
 * Runtime data path:
 ...
 *
 * This lets the master push one known runtime config to nodes without
 * reflashing their firmware.
 */
 ...
 *
 * tools/decode_log.py decodes this format to CSV after serial download.
 */
...
#else
    ESP_LOGI(TAG, "GPS disabled for this build");
#endif
...
#else
    ESP_LOGI(TAG, "RPM sampler disabled for this build");
#endif
